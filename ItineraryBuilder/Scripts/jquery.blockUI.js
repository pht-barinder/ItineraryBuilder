...
; (function($) {
    ...
    function install(el, opts) {
        ...
        var lyr2 = $('<div class="blockUI blockOverlay" style="z-index:' + z++ + ';display:none;cursor:inherit;border:none;margin:0;padding:0;width:100%;height:100%;top:0;left:0"></div>');
        ...
        if (ie6 || expr) {
            ...
            //Ankit:Added try catch to avoid the exception ofr IE8
            try {
